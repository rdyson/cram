...
create table if not exists uploaded_assets (
  ...
  type text not null check (type in ('markdown', 'screenshot')),
...
create table if not exists study_items (
  ...
  source text not null check (source in ('markdown_notes', 'screenshot', 'blueprint_gap', 'diagnostic', 'remediation')),
